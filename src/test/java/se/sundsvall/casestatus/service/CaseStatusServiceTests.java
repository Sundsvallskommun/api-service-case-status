...
import se.sundsvall.casestatus.integration.db.model.status.views.IncidentOpeneView;
...
class CaseStatusServiceTests {
	...
	void getOepStatus_caseStatusFoundInCaseManagement() {
		...
		when(caseManagementOpeneViewRepositoryMock.findByCaseManagementIdAndMunicipalityId("someStatus", "2281"))
		...
		verify(caseManagementOpeneViewRepositoryMock).findByCaseManagementIdAndMunicipalityId(any(String.class), any(String.class));
	...
	void getOepStatus_caseStatusNotFoundInCaseManagement() {
		...
		when(incidentOpeneViewRepositoryMock.findByIncidentIdAndMunicipalityId(678, "2281"))
		...
		verify(incidentOpeneViewRepositoryMock).findByIncidentIdAndMunicipalityId(any(Integer.class), any(String.class));
	...
	void getCaseStatus_caseStatusFoundInCaseManagement() {
		...
		when(caseManagementOpeneViewRepositoryMock.findByCaseManagementIdAndMunicipalityId(any(String.class), any(String.class))).thenReturn(Optional.of
	...
	void getCaseStatuses() {
		...
		when(caseManagementOpeneViewRepositoryMock.findByCaseManagementIdAndMunicipalityId(any(String.class), any(String.class)))
		...
		verify(caseManagementOpeneViewRepositoryMock, times(2)).findByCaseManagementIdAndMunicipalityId(any(String.class), any(String.class));
