...
class MapperTest {
	...
	void toCacheCompanyCaseStatus(
		...
		final var result = mapper.toCacheCompanyCaseStatus(errandStatusDoc, errandDoc, "someOrganisationNumber");
	...
	void toCachePrivateCaseStatus(@Load(value = "/xml/getErrand_ANDRINGAVSLUTFORSALJNINGTOBAKSVAROR.xml") String getErrandXML,
		...
		final var result = mapper.toCachePrivateCaseStatus(errandStatusDoc, errandDoc, "somePersonId");
	...
	void toCacheUnknowCaseStatus(@Load(value = "/xml/getErrand_ANDRINGAVSLUTFORSALJNINGTOBAKSVAROR.xml") String getErrandXML,
		...
		final var result = mapper.toCacheUnknowCaseStatus(errandStatusDoc, errandDoc);
