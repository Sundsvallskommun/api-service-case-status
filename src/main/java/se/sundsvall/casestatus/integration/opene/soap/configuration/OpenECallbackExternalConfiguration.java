...
public class OpenECallbackExternalConfiguration {

	public static final String OPENE_CALLBACK_EXTERNAL_CLIENT = "opene-callback-external";
	...
	@Bean
	FeignBuilderCustomizer externalFeignBuilderCustomizer(final OpenECallbackProperties properties) {
