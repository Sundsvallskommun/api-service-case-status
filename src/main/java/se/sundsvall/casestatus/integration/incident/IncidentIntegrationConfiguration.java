...
@EnableConfigurationProperties(IncidentIntegrationProperties.class)
class IncidentIntegrationConfiguration {

    private final IncidentIntegrationProperties properties;

    IncidentIntegrationConfiguration(final IncidentIntegrationProperties properties) {
    ...
    ClientRegistration clientRegistration() {
        return ClientRegistration
                .withRegistrationId(IncidentIntegration.INTEGRATION_NAME)
    ...
    ErrorDecoder errorDecoder() {
        return new ProblemErrorDecoder(IncidentIntegration.INTEGRATION_NAME);
    }
}
