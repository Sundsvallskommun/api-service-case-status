...
public class CaseDataConfiguration {
	...
	@Bean
	FeignBuilderCustomizer feignBuilderCustomizer(final CaseDataProperties caseDataProperties, final ClientRegistrationRepository clientRegistrationRepository) {
